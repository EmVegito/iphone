      ...
      <div className="screen-max-width">
        ...
        <div className="flex flex-col justify-center overflow-hidden">
          ...
          <div className="flex-center flex-col sm:px-10">
            <div className="relative h-[50vh] flex-center w-full flex items-center">
              <video
                playsInline
                id="exploreVideo"
              ...
              <div className="flex-1 flex-center">
                <p className="feature-text g_text">
                  ...
                  <span className="text-white">
                    the fist iPhone to feature an aerospace-grade titanium
                    design,
                  </span>
                  using the same alloy that spacecraft use missions to Mars.
                </p>
              </div>
              <div className="flex-1 flex-center">
                <p className="feature-text g_text">
